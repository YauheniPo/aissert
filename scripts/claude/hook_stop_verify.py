#!/usr/bin/env python3
"""Stop hook: run deterministic checks before Claude Code ends a turn.
...
def main() -> int:
    ...
    if warnings:
        print("Claude Stop hook warnings: " + "; ".join(warnings), file=sys.stderr)

    if failures:
        print("Claude Stop hook blocked completion. Fix these checks:", file=sys.stderr)
